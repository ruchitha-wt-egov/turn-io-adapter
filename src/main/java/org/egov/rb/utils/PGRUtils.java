...
import org.egov.rb.contract.CountResponse;
import org.egov.rb.contract.RequestInfoWrapper;
import org.egov.rb.contract.SearcherRequest;
...
public class PGRUtils {
	...
	public ServiceResponse getDefaultServiceResponse(RequestInfo requestInfo) {
		return new ServiceResponse(factory.createResponseInfoFromRequestInfo(requestInfo, false),
				null, null, null, new ArrayList<Service>(), new ArrayList<ActionHistory>());
	}
